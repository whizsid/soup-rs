...
impl Date {
    ...
    #[cfg(any(feature = "v2_24", feature = "dox"))]
    pub fn to_timeval(&mut self) -> glib::TimeVal {
        unsafe {
            let mut time = glib::TimeVal::uninitialized();
            soup_sys::soup_date_to_timeval(self.to_glib_none_mut().0, time.to_glib_none_mut().0);
            time
        }
    }
}
