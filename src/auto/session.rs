...
pub trait SessionExt: 'static {
    ...
    //fn add_feature(&self, feature: /*Ignored*/&SessionFeature);
    ...
    //fn connect_async<P: IsA<gio::Cancellable>, Q: FnOnce(Result</*Ignored*/gio::IOStream, glib::Error>) + Send + 'static>(&self, uri: &mut URI, cancellable: Option<&P>, progress_callback: /*Unimplemented*/FnOnce(&Session, /*Ignored*/gio::SocketClientEvent, /*Ignored*/gio::IOStream), callback: Q);

    //
    //#[cfg(any(feature = "v2_62", feature = "dox"))]
    //fn connect_async_future(&self, uri: &mut URI, progress_callback: /*Unimplemented*/FnOnce(&Session, /*Ignored*/gio::SocketClientEvent, /*Ignored*/gio::IOStream)) -> Pin<Box_<dyn std::future::Future<Output = Result</*Ignored*/gio::IOStream, glib::Error>> + 'static>>;

    fn get_async_context(&self) -> Option<glib::MainContext>;

    //#[cfg(any(feature = "v2_26", feature = "dox"))]
    //fn get_feature(&self, feature_type: glib::types::Type) -> /*Ignored*/Option<SessionFeature>;

    //#[cfg(any(feature = "v2_28", feature = "dox"))]
    //fn get_feature_for_message<P: IsA<Message>>(&self, feature_type: glib::types::Type, msg: &P) -> /*Ignored*/Option<SessionFeature>;

    //#[cfg(any(feature = "v2_26", feature = "dox"))]
    //fn get_features(&self, feature_type: glib::types::Type) -> /*Ignored*/Vec<SessionFeature>;
    ...
    //#[cfg(any(feature = "v2_24", feature = "dox"))]
    //fn remove_feature(&self, feature: /*Ignored*/&SessionFeature);
    ...
    #[cfg(any(feature = "v2_50", feature = "dox"))]
    fn websocket_connect_async<P: IsA<Message>, Q: IsA<gio::Cancellable>, R: FnOnce(Result<WebsocketConnection, glib::Error>) + Send + 'static>(&self, msg: &P, origin: Option<&str>, protocols: &[&str], cancellable: Option<&Q>, callback: R);

    
    #[cfg(any(feature = "v2_50", feature = "dox"))]
    fn websocket_connect_async_future<P: IsA<Message> + Clone + 'static>(&self, msg: &P, origin: Option<&str>, protocols: &[&str]) -> Pin<Box_<dyn std::future::Future<Output = Result<WebsocketConnection, glib::Error>> + 'static>>;
    ...
    //#[cfg(any(feature = "v2_24", feature = "dox"))]
    //fn get_property_add_feature(&self) -> /*Ignored*/Option<SessionFeature>;

    //#[cfg(any(feature = "v2_24", feature = "dox"))]
    //fn set_property_add_feature<P: IsA</*Ignored*/SessionFeature> + SetValueOptional>(&self, add_feature: Option<&P>);
    ...
    #[cfg(any(feature = "v2_42", feature = "dox"))]
    fn get_property_proxy_resolver(&self) -> Option<gio::ProxyResolver>;

    #[cfg(any(feature = "v2_42", feature = "dox"))]
    fn set_property_proxy_resolver<P: IsA<gio::ProxyResolver> + SetValueOptional>(&self, proxy_resolver: Option<&P>);
...
impl<O: IsA<Session>> SessionExt for O {
    ...
    //#[cfg(any(feature = "v2_24", feature = "dox"))]
    //fn add_feature(&self, feature: /*Ignored*/&SessionFeature) {
    //    unsafe { TODO: call soup_sys:soup_session_add_feature() }
    //}
    ...
    //#[cfg(any(feature = "v2_26", feature = "dox"))]
    //fn get_feature(&self, feature_type: glib::types::Type) -> /*Ignored*/Option<SessionFeature> {
    //    unsafe { TODO: call soup_sys:soup_session_get_feature() }
    //}

    //#[cfg(any(feature = "v2_28", feature = "dox"))]
    //fn get_feature_for_message<P: IsA<Message>>(&self, feature_type: glib::types::Type, msg: &P) -> /*Ignored*/Option<SessionFeature> {
    //    unsafe { TODO: call soup_sys:soup_session_get_feature_for_message() }
    //}

    //#[cfg(any(feature = "v2_26", feature = "dox"))]
    //fn get_features(&self, feature_type: glib::types::Type) -> /*Ignored*/Vec<SessionFeature> {
    //    unsafe { TODO: call soup_sys:soup_session_get_features() }
    //}
    ...
    //#[cfg(any(feature = "v2_24", feature = "dox"))]
    //fn remove_feature(&self, feature: /*Ignored*/&SessionFeature) {
    //    unsafe { TODO: call soup_sys:soup_session_remove_feature() }
    //}
    ...
    fn websocket_connect_async<P: IsA<Message>, Q: IsA<gio::Cancellable>, R: FnOnce(Result<WebsocketConnection, glib::Error>) + Send + 'static>(&self, msg: &P, origin: Option<&str>, protocols: &[&str], cancellable: Option<&Q>, callback: R) {
        let user_data: Box_<R> = Box_::new(callback);
        unsafe extern "C" fn websocket_connect_async_trampoline<R: FnOnce(Result<WebsocketConnection, glib::Error>) + Send + 'static>(_source_object: *mut gobject_sys::GObject, res: *mut gio_sys::GAsyncResult, user_data: glib_sys::gpointer) {
            let mut error = ptr::null_mut();
            let ret = soup_sys::soup_session_websocket_connect_finish(_source_object as *mut _, res, &mut error);
            let result = if error.is_null() { Ok(from_glib_full(ret)) } else { Err(from_glib_full(error)) };
            let callback: Box_<R> = Box_::from_raw(user_data as *mut _);
            callback(result);
        }
        let callback = websocket_connect_async_trampoline::<R>;
        unsafe {
            soup_sys::soup_session_websocket_connect_async(self.as_ref().to_glib_none().0, msg.as_ref().to_glib_none().0, origin.to_glib_none().0, protocols.to_glib_none().0, cancellable.map(|p| p.as_ref()).to_glib_none().0, Some(callback), Box_::into_raw(user_data) as *mut _);
        }
    }
    ...
    fn get_property_proxy_resolver(&self) -> Option<gio::ProxyResolver> {
        unsafe {
            let mut value = Value::from_type(<gio::ProxyResolver as StaticType>::static_type());
    ...
    #[cfg(any(feature = "v2_30", feature = "dox"))]
    fn connect_connection_created<F: Fn(&Self, &glib::Object) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn connection_created_trampoline<P, F: Fn(&P, &glib::Object) + 'static>(this: *mut soup_sys::SoupSession, connection: *mut gobject_sys::GObject, f: glib_sys::gpointer)
            where P: IsA<Session>
        {
            let f: &F = &*(f as *const F);
            f(&Session::from_glib_borrow(this).unsafe_cast(), &from_glib_borrow(connection))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"connection-created\0".as_ptr() as *const _,
                Some(transmute(connection_created_trampoline::<Self, F> as usize)), Box_::into_raw(f))
        }
    }
    ...
    fn connect_request_started<F: Fn(&Self, &Message, &Socket) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn request_started_trampoline<P, F: Fn(&P, &Message, &Socket) + 'static>(this: *mut soup_sys::SoupSession, msg: *mut soup_sys::SoupMessage, socket: *mut soup_sys::SoupSocket, f: glib_sys::gpointer)
            where P: IsA<Session>
        {
            let f: &F = &*(f as *const F);
            f(&Session::from_glib_borrow(this).unsafe_cast(), &from_glib_borrow(msg), &from_glib_borrow(socket))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"request-started\0".as_ptr() as *const _,
                Some(transmute(request_started_trampoline::<Self, F> as usize)), Box_::into_raw(f))
        }
    }
    ...
    #[cfg(any(feature = "v2_30", feature = "dox"))]
    fn connect_tunneling<F: Fn(&Self, &glib::Object) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn tunneling_trampoline<P, F: Fn(&P, &glib::Object) + 'static>(this: *mut soup_sys::SoupSession, connection: *mut gobject_sys::GObject, f: glib_sys::gpointer)
            where P: IsA<Session>
        {
            let f: &F = &*(f as *const F);
            f(&Session::from_glib_borrow(this).unsafe_cast(), &from_glib_borrow(connection))
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"tunneling\0".as_ptr() as *const _,
                Some(transmute(tunneling_trampoline::<Self, F> as usize)), Box_::into_raw(f))
        }
    }
