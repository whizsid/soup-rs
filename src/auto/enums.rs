...
impl fmt::Display for TLDError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "TLDError::{}", match *self {
            TLDError::InvalidHostname => "InvalidHostname",
            TLDError::IsIpAddress => "IsIpAddress",
            TLDError::NotEnoughDomains => "NotEnoughDomains",
            TLDError::NoBaseDomain => "NoBaseDomain",
            TLDError::NoPslData => "NoPslData",
            _ => "Unknown",
        })
    }
}
...
#[cfg(any(feature = "v2_40", feature = "dox"))]
#[doc(hidden)]
impl ToGlib for TLDError {
    type GlibType = soup_sys::SoupTLDError;

    fn to_glib(&self) -> soup_sys::SoupTLDError {
        match *self {
            TLDError::InvalidHostname => soup_sys::SOUP_TLD_ERROR_INVALID_HOSTNAME,
            TLDError::IsIpAddress => soup_sys::SOUP_TLD_ERROR_IS_IP_ADDRESS,
            TLDError::NotEnoughDomains => soup_sys::SOUP_TLD_ERROR_NOT_ENOUGH_DOMAINS,
            TLDError::NoBaseDomain => soup_sys::SOUP_TLD_ERROR_NO_BASE_DOMAIN,
            TLDError::NoPslData => soup_sys::SOUP_TLD_ERROR_NO_PSL_DATA,
            TLDError::__Unknown(value) => value
        }
    }
}
...
#[cfg(any(feature = "v2_40", feature = "dox"))]
#[doc(hidden)]
impl FromGlib<soup_sys::SoupTLDError> for TLDError {
    fn from_glib(value: soup_sys::SoupTLDError) -> Self {
        skip_assert_initialized!();
        match value {
            0 => TLDError::InvalidHostname,
            1 => TLDError::IsIpAddress,
            2 => TLDError::NotEnoughDomains,
            3 => TLDError::NoBaseDomain,
            4 => TLDError::NoPslData,
            value => TLDError::__Unknown(value),
        }
    }
}
...
impl ErrorDomain for TLDError {
    fn domain() -> Quark {
        skip_assert_initialized!();
        unsafe { from_glib(soup_sys::soup_tld_error_quark()) }
    }
    ...
    fn from(code: i32) -> Option<Self> {
        skip_assert_initialized!();
        match code {
            0 => Some(TLDError::InvalidHostname),
            1 => Some(TLDError::IsIpAddress),
            2 => Some(TLDError::NotEnoughDomains),
            3 => Some(TLDError::NoBaseDomain),
            4 => Some(TLDError::NoPslData),
            value => Some(TLDError::__Unknown(value)),
        }
    }
}
...
impl StaticType for TLDError {
    fn static_type() -> Type {
        unsafe { from_glib(soup_sys::soup_tld_error_get_type()) }
    }
}

#[cfg(any(feature = "v2_40", feature = "dox"))]
impl<'a> FromValueOptional<'a> for TLDError {
    unsafe fn from_value_optional(value: &Value) -> Option<Self> {
        Some(FromValue::from_value(value))
    }
}
...
#[cfg(any(feature = "v2_40", feature = "dox"))]
impl<'a> FromValue<'a> for TLDError {
    unsafe fn from_value(value: &Value) -> Self {
        from_glib(gobject_sys::g_value_get_enum(value.to_glib_none().0))
    }
}
